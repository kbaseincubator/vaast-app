...
class TreeVizRegion(Render):
    ...
    def _set_layout(self) -> Component:
        initial_data = {"name": "Bacteria", "rank": "superkingdom"}
        ...
        initial_fig.update_layout(height=600, title="Taxonomy Tree (Root: Bacteria | Showing: order)")
        ...
        return dbc.Container(
            [
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            dbc.Button("Reset View", id="tree-viz-reset-btn", size="sm", color="secondary"),
                            width="auto",
                        ),
                        dbc.Col(
